...
public class WordStatistics extends Configured implements Tool {
	...
	public static class MapClass extends Mapper<LongWritable, Text, Text, WordStatisticsWritable> {
		...
		public void map(LongWritable key, Text value, Context context)
			...
			while (tokenizer.hasMoreTokens()) {
				...
				token = token.toLowerCase().replaceAll("[-_.,/?;:!<>{}()\"]","").replaceAll("--", "");
	...
	public static class ReduceClass extends Reducer<Text, WordStatisticsWritable, Text, WordStatisticsWritable> {
		...
		public void reduce(Text key, Iterable<WordStatisticsWritable> values, Context context)
			...
			WordStatisticsWritable out = new WordStatisticsWritable();
			out.setLongs(count, docCount, countSquared);
		...
		private double getMean(long count, long docCount){
			double result = count/(double)docCount;
			return result;
		}

		private double getVariance(long countSquared, long docCount, double mean) {
			double result = (countSquared / (double)docCount) - (mean * mean);
			return result;
		}
	}
	...
	public static class WordStatisticsWritable implements Writable {
		...
		public void setLongs(long count, long docCount, long countSquared) {
			this.count = count;
...
//		public double getVariance() { return variance; }
		...
		public String toString() {
			return this.docCount + "," + this.mean + "," + this.variance;
		}

		@Override
		public boolean equals(Object rhs) {
			WordStatisticsWritable other = (WordStatisticsWritable) rhs;
			//If Equal
